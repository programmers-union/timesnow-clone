    ...
    return (
        <div className="container my-5 with100">
        {/* Category links */}
        <div className="mb-2">
            <a
            href="#"
        ...
        {/* Title */}
        <h2 className="fw-bold mb-3 mx-0 mx-lg-4
">{title}</h2>

        {/* Subtitle / Description */}
        <p className="text-muted fs-5 mb-4 mx-0 mx-lg-4
">{subtitle}</p>
        ...
        <div className="text-center">
            ...
            />
            <p className="text-center  text-muted mt-2 mx-0 mx-lg-4
">{subtitle} </p>
        </div>
